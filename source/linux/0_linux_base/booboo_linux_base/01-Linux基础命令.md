...
- 在教室物理机包括rhel7和rhel6两台实验虚拟机，上打开虚拟机命令: _rht-vmctl start rhel7_
  - 在物理机上远程登陆到虚拟机rhel7 _ssh root@rhel7-fN_ ，_N_ 为你的机器编号， *root*密码都是*uplooking*，系统中有一个普通用户*student*，其密码为*student*。
